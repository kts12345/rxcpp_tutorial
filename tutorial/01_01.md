...
* 문법(grammer) : on_next*(on_completed|on_error)?
  ...
  * 예시
    * [on_next, on_next, on_complete]  <=   valid
    * [on_next, on_next, on_error]     <=   valid
    * [on_complete]                    <=   valid
    * [on_error]                       <=   valid
    * []                               <=   valid
    * [on_next, on_complete, on_next]  <= invalid
    * [on_next, on_error,    on_next]  <= invalid
    * [on_next, on_complete, on_error] <= invalid
    * [on_complete, on_error]          <= invalid
    * [on_error, on_complete, ]        <= invalid
* on_dispose 는  
